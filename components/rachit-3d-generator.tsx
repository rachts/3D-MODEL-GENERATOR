    ...
    <div className="relative h-[100dvh] w-full">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        <div className="absolute top-6 left-6 pointer-events-auto">
          <h1 className="text-3xl text-white font-normal tracking-normal">Rachit's 3D Generator</h1>
          <p className="text-gray-400 text-sm mt-1 tracking-normal">AI-Powered 3D Model Creation</p>
        </div>
